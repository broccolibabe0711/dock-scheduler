...
def verify(base_url, write_smoke=False):
    ...
    with httpx.Client(base_url=base_url.rstrip('/'), timeout=60, follow_redirects=True) as client:
        ...
        for path, marker in [('/', 'inputs.js?v=20260920-inputs2'), ('/guide.html', 'Rules and assumptions'), ('/app.js', 'setupInputChoices'), ('/audit.js', 'filterRows'), ('/inputs.js', 'insertTemplate')]:
            r = client.get(path)
            r.raise_for_status()
